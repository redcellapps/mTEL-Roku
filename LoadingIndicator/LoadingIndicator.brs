...
sub onImageHeightChange()
    ? "LoadingIndicator.brs - [onImageHeightChange]"
...
sub onFadeAnimationStateChange()
    ? "LoadingIndicator.brs - [onFadeAnimationStateChange]"
...
function getComponentWidth() as Float
    ? "LoadingIndicator.brs - [getComponentWidth]"
    if m.top.width = 0
...
function getComponentHeight() as Float
    ? "LoadingIndicator.brs - [getComponentHeight]"
    if m.top.height = 0
...
function getParentWidth() as Float
    ? "LoadingIndicator.brs - [getParentWidth]"
...
function getParentHeight() as Float
    ? "LoadingIndicator.brs - [getParentHeight]"
...
sub startAnimation()
    ? "LoadingIndicator.brs - [startAnimation]"
